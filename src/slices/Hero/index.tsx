    ...
    >
      ...
      <div className="grid">
        ...
        <div className="text-side relative z-[80] grid h-screen items-center gap-4 md:grid-cols-2">
          ...
          />
          <div>
            <h2 className="text-side__heading text-balance text-5xl font-black uppercase text-sky-950 lg:text-8xl">
              <TextSplitter text={asText(slice.primary.second_heading)} />
            </h2>
            <div className="text-side__body mt-4 max-w-xl text-balance text-xl font-normal text-sky-950">
